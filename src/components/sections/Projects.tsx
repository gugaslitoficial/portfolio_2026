...
export async function Projects() {
  ...
  return (
    <section id="projetos" className="relative border-t border-border-subtle" style={{ padding: 'clamp(72px, 11vh, 128px) 0' }} >
      <div className="max-w-285 mx-auto reveal-on-scroll" style={{ padding: '0 clamp(20px, 5vw, 40px)' }} >
        ...
        />
        <p className="font-mono text-[13px] text-dim inline-flex items-center leading-normal mb-9.5 gap-2.25">
